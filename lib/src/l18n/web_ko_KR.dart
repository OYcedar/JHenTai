class WebKoKR {
  static Map<String, String> keys() {
    return {
      ...
      'enableCustomReadBrightness': '리더 밝기 사용자 지정',
      'customBrightness': '밝기',
      'webCustomReadBrightnessHint': '기기 밝기를 바꾸지 않고 웹 오버레이로 리더를 어둡게 합니다.',
      ...
      'local.scanNow': '지금 스캔',
      'local.scanFailed': '로컬 갤러리 스캔 실패: @error',
      'local.empty': '비어 있음',
      ...
      'settings.restoreTasksLoadFailed': '작업 자동 복원 설정 로드 실패: @error',
      'settings.speedLimitLoadFailed': '다운로드 속도 제한 로드 실패: @error',
      'settings.downloadServerRuntime': '서버 런타임',
      'settings.runtimeLoadFailed': '서버 런타임 설정 로드 실패: @error',
      ...
      'settings.cloudServiceAvailable': 'JHenTai 클라우드 설정 서비스를 사용할 수 있습니다',
      'settings.cloudServiceUnavailable': 'JHenTai 클라우드 설정 서비스를 사용할 수 없습니다',
      'settings.cloudShareCode': '공유 코드',
      'settings.cloudConfigType': '설정 유형',
      ...
      'settings.cloudConfigLoadFailed': '클라우드 설정 로드 실패: @error',
      'settings.cloudShareCodeLoadFailed': '공유 코드 조회 실패: @error',
      ...
      'settings.searchLog': '로그 검색...',
      'settings.noLogMatches': '일치 항목 없음',
      'settings.logMatchCounter': '@current / @total',
      'settings.previousMatch': '이전 일치 항목',
      'settings.nextMatch': '다음 일치 항목',
      ...
      'settings.changeWebPin': 'PIN 변경',
      'settings.currentWebPinHint': '현재 PIN을 입력하세요',
      'settings.newWebPinHint': '새 PIN을 입력하세요',
      'settings.webPinChanged': 'PIN이 변경되었습니다',
      ...
      'settings.loadWheelSettingsFailed': '마우스 휠 설정 로드 실패: @error',
      'settings.saveWheelSettingsFailed': '마우스 휠 설정 저장 실패: @error',
      ...
      'history.deleteSuccess': '방문 기록 항목을 삭제했습니다',
      'history.deleteFailed': '방문 기록 삭제 실패: @error',
      'history.clearSuccess': '방문 기록을 삭제했습니다',
      'history.clearFailed': '방문 기록 전체 삭제 실패: @error',
      ...
      'searchHistory.hide': '검색 기록 숨기기',
      'searchHistory.show': '검색 기록 표시',
      ...
      'quickSearch.orderSaveFailed': '빠른 검색 순서 저장 실패: @error',
      ...
      'useBuiltInBlockedUsersLoadFailed': '내장 사용자 차단 목록 설정 로드 실패: @error',
      ...
      'blockRule.loadFailed': '차단 규칙 로드 실패: @error',
      'blockRule.saveFailed': '차단 규칙 저장 실패: @error',
      'blockRule.deleteFailed': '차단 규칙 삭제 실패: @error',
      'blockRule.saveSuccess': '차단 규칙이 저장되었습니다',
      'blockRule.deleteSuccess': '차단 규칙이 삭제되었습니다',
      'blockRule.target': '대상',
      ...
      'usertags.watch': '관심',
      'usertags.hidden': '숨김',
      'usertags.watchInSet': '태그 세트에 관심 추가',
      'usertags.hiddenInSet': '태그 세트에 숨김 추가',
      'usertags.manage': '태그 세트 관리',
      ...
      'downloads.clearGroupConfirm': '"@group" 그룹의 @count개 작업을 기본 그룹으로 이동할까요?',
      'downloads.groupCleared': '@count개 작업을 기본 그룹으로 이동했습니다',
