class WebRuRU {
  static Map<String, String> keys() {
    return {
      ...
      'yealicoConfigHint':
          'Сервер генерирует правило сайта только для чтения для Yealico: скопируйте JSON правила или скачайте файл правила и вставьте его в редактор правил Yealico, чтобы читать галереи, архивы и локальные библиотеки, скачанные JHenTai.',
      ...
      'yealicoConfigDownload': 'Скачать файл правила',
      'yealicoConfigQrHint':
          'После импорта нажмите Generate QR Code в редакторе правил Yealico, чтобы поделиться правилом с другими устройствами по QR-коду.',
      'yealicoConfigImportSteps':
          'Импорт: Yealico → Правила → Изменить → вставьте JSON правила и сохраните (или откройте скачанный файл правила в Yealico).',
      'yealicoConfigRotate': 'Перегенерировать',
      'yealicoConfigRotateConfirm':
          'После перегенерации старое правило перестанет работать. Скопируйте/скачайте и импортируйте заново.',
      'yealicoConfigRotated': 'Перегенерировано, импортируйте правило заново',
