class WebZhCN {
  static Map<String, String> keys() {
    return {
      ...
      'settings.importDataSuccessDetail': '已导入 @count 项数据：@detail',
      'settings.importNoChange': '导入完成，但没有写入新的数据。请检查预检结果或文件内容。',
      'settings.importDataFailed': '导入数据失败：@error',
      'settings.importStatusAnalyzing': '已读取 @name（@size），正在预检。',
      'settings.importStatusCancelled': '已取消导入：@name',
      'settings.importStatusBackingUp': '正在下载导入前备份。',
      'settings.importStatusImporting': '正在导入 @name。',
      'settings.importStatusDone': '@source 已导入 @count 项：@detail',
      'settings.importStatusNoChange': '@source 导入完成，但没有写入新的数据。',
      'settings.importStatusFailed': '导入失败：@error',
      'settings.importPreviewTitle': '导入预检',
      'settings.importPreviewSource': '来源：@source',
      'settings.importPreviewFile': '文件：@name（@size）',
      ...
      'settings.importPreviewEmpty': '没有发现可导入项目。文件已读取，但内容不会写入当前服务端。',
      'settings.importPreviewLocalReadHint': '文件只在浏览器中读取；点击“备份并导入”后才会写入服务端。',
