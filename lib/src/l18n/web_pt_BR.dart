class WebPtBR {
  static Map<String, String> keys() {
    return {
      ...
      'reader.shortcuts': 'Atalhos',
      'reader.shortcutRightKeys': '→ / ↓ / D',
      'reader.shortcutLeftKeys': '← / ↑ / A',
      'reader.shortcutNext': 'Próxima página',
      'reader.shortcutPrev': 'Página anterior',
      'reader.shortcutToggleMenu': 'Mostrar/ocultar menu',
      'reader.shortcutBack': 'Voltar',
      ...
      'usertags.watchInSet': 'Observar em conjunto',
      'usertags.hiddenInSet': 'Ocultar em conjunto',
      'usertags.manage': 'Gerenciar conjuntos',
      ...
      'usertags.tagColor': 'Cor da tag',
      'usertags.tagSetColor': 'Cor do conjunto de tags',
      'usertags.changeColor': 'Alterar cor',
      'usertags.colorDefault': 'Usar cor padrão',
      ...
      'downloads.selectVisible': 'Selecionar tarefas visíveis',
      ...
      'downloads.reDownloadBatchConfirm':
          'Excluir arquivos e reiniciar @scope?',
      ...
      'downloads.deleteBatchConfirm': 'Escolha como excluir @scope.',
      'downloads.visibleTaskCount': '@count tarefas visíveis',
      'downloads.selectedTaskCount': '@count tarefas selecionadas',
