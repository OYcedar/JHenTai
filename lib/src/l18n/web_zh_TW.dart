class WebZhTW {
  static Map<String, String> keys() {
    return {
      ...
      'common.update': '更新',
      'common.download': '下載',
      'superResolution.title': '圖片超解析度',
      'superResolution.summary': '檢測 GPU/Vulkan、下載模型，並管理 Docker 超分任務。',
      'superResolution.capability': '執行環境自檢',
      'superResolution.arch': '架構',
      ...
      'superResolution.modelDownloadStarted': '已開始下載模型',
      'superResolution.modelDownloading': '正在下載 @progress%',
      'superResolution.modelImporting': '正在匯入模型包',
      'superResolution.modelDownloadFailed': '模型下載失敗',
      'superResolution.installedNotExecutable': '已安裝，但二進位檔不可執行',
      'superResolution.modelSource': '下載源：@source',
      'superResolution.repairPermission': '修復權限',
      'superResolution.modelPermissionRepaired': '模型執行權限已修復',
      'superResolution.importModel': '匯入 ZIP',
      'superResolution.jobs': '任務',
      'superResolution.noJobs': '暫無超分任務',
      'superResolution.deleteHint': '刪除任務並清理已產生的超分圖片？',
      'superResolution.start': '圖片超分',
      'superResolution.model': '模型',
      'superResolution.tileSize': 'Tile 大小',
      'superResolution.gpuAutoHint': '留空自動選擇',
      ...
      'customBrightness': '亮度',
      'webCustomReadBrightnessHint': '使用網頁遮罩調暗閱讀器，不會修改裝置系統亮度。',
      ...
      'downloads.wsConnected': '下載即時連線正常',
      'downloads.wsConnecting': '正在連接下載即時狀態...',
      'downloads.wsReconnecting': '下載即時連線已中斷，正在重連；成功後會自動同步任務狀態。',
      'downloads.wsDisconnected': '下載即時連線不可用，可以手動重新整理任務列表。',
      ...
      'local.scanNow': '立即掃描',
      'local.scanFailed': '掃描本機畫廊失敗: @error',
      'local.scanProgress': '正在掃描，已發現 @count 個畫廊，用時 @elapsed',
      'local.empty': '空',
      ...
      'settings.logout': '登出',
      'settings.logoutConfirm': '確定要登出目前帳號嗎？',
      ...
      'settings.ehQuotaResetConfirm': '重設圖片配額將花費 @cost GP，確定繼續嗎？',
      ...
      'settings.maintenanceCenter': '維護中心',
      'settings.maintenanceCenterSummary': '檢視映像版本、更新檢查、SQLite 備份和容量摘要。',
      'settings.troubleshootingWorkbench': '排障工作台',
      'settings.troubleshootingWorkbenchSummary':
          '集中檢視診斷、日誌、代理和超解析狀態，並執行手動排障測試。',
      'settings.setupChecklist': '啟動清單',
      'settings.setupChecklistSummaryHint': '檢查首次部署和升級後的可用狀態，不會自動執行外網探測。',
      'settings.setupChecklistHint':
          '此清單只讀取本機執行狀態；需要測試網路或 H@H 時，請到排障工作台手動執行主動測試。',
      'settings.setupChecklistSummary': '就緒狀態總覽',
      'settings.setupChecklistSummaryBody':
          '@total 項檢查，@errors 個錯誤，@warnings 個警告。',
      'settings.setupChecklistLoadFailed': '載入啟動清單失敗: @error',
      'settings.copySetupChecklist': '複製啟動清單',
      'settings.setupChecklistCopied': '啟動清單已複製',
      'settings.maintenanceLoadFailed': '載入維護資訊失敗: @error',
      'settings.maintenanceRuntime': '目前執行版本',
      'settings.appVersionLabel': '應用程式版本',
      'settings.dockerImageTag': 'Docker 映像標籤',
      'settings.forkRevision': 'Fork 版本號',
      'settings.imageChannel': '映像通道',
      'settings.maintenanceUpdate': '映像更新',
      'settings.checkDockerUpdate': '檢查更新',
      'settings.updateCheckManualHint': '不會自動存取外網；需要時手動檢查 Docker Hub 最新標籤。',
      'settings.currentImageTag': '目前標籤',
      'settings.latestImageTag': '最新標籤',
      'settings.maintenanceBackup': '更新前備份',
      'settings.sqliteBackupSensitiveHint':
          'SQLite 備份包含登入 Cookie、API Token、設定和下載工作，是敏感檔案；不包含圖片、下載目錄或本機圖庫。',
      'settings.downloadSqliteBackup': '下載 SQLite 備份',
      'settings.sqliteBackupDownloaded': 'SQLite 備份已開始下載',
      'settings.sqliteBackupFailed': 'SQLite 備份失敗: @error',
      'settings.restoreSqliteBackup': '恢復 SQLite 備份',
      'settings.sqliteRestorePreviewTitle': '恢復 SQLite 備份？',
      'settings.sqliteRestorePreviewIntro':
          '將用所選備份取代目前 Web 資料。確認前會自動下載一次目前 SQLite 備份。',
      'settings.confirmRestoreSqliteBackup': '備份目前資料庫並恢復',
      'settings.sqliteRestoreSuccess':
          'SQLite 備份已恢復；已暫停 @gallery 個畫廊任務和 @archive 個歸檔任務。',
      'settings.sqliteRestoreFailed': 'SQLite 恢復失敗: @error',
      'settings.sqliteRestoreGalleryDownloads': '畫廊下載任務',
      'settings.sqliteRestoreArchiveDownloads': '歸檔下載任務',
      'settings.sqliteRestoreGalleryImages': '下載圖片記錄',
      'settings.sqliteRestoreWarnToken': '目前 API Token 會保留。',
      'settings.sqliteRestoreWarnCookies': 'EH 登入 Cookie 會從備份恢復。',
      'settings.sqliteRestoreWarnPageCache': '頁面快取不會恢復。',
      'settings.sqliteRestoreWarnDownloadsPaused': '備份中的下載中任務會改為暫停。',
      'settings.sqliteRestoreWarnNoDownloads': '該備份不包含下載任務。',
      'settings.maintenanceStorage': '容量摘要',
      'settings.databaseSize': '資料庫大小',
      'settings.logsSize': '日誌大小',
      'settings.pageCacheSize': '頁面快取大小',
      'settings.pageCacheCount': '頁面快取項目',
      'settings.maintenancePaths': '關鍵路徑',
      'settings.maintenanceTips': '維護建議',
      'settings.maintenanceTipPinVersion':
          '更新 compose 時建議固定明確版本標籤，不要長期使用 latest。',
      'settings.maintenanceTipBackup': '更新前至少下載一次 SQLite 備份，並保留目前 compose 設定。',
      'settings.maintenanceTipNoImageBackup':
          '圖片和本機圖庫通常很大，請透過 NAS／宿主機快照或目錄備份處理。',
      'settings.deploymentDiagnostics': '部署自檢',
      'settings.deploymentDiagnosticsSummaryHint':
          '檢查 API、WebSocket、目錄權限、資料庫、代理和日誌狀態。',
      'settings.copyDeploymentDiagnostics': '複製部署診斷',
      'settings.deploymentDiagnosticsSummary': '部署狀態總覽',
      'settings.deploymentDiagnosticsSummaryBody': '@errors 個錯誤，@warnings 個警告。',
      'settings.generatedAt': '產生時間',
      'settings.diagnosticsLoadFailed': '載入部署診斷失敗: @error',
      'settings.diagnosticsGroupService': '服務入口',
      'settings.diagnosticsGroupStorage': '儲存目錄',
      'settings.diagnosticsGroupDatabase': '資料庫',
      'settings.diagnosticsGroupLocalGallery': '本機圖庫',
      'settings.diagnosticsGroupNetwork': '網路代理',
      'settings.diagnosticsGroupLogs': '日誌',
      'settings.diagnosticsStatusOk': '正常',
      'settings.diagnosticsStatusWarn': '警告',
      'settings.diagnosticsStatusError': '錯誤',
      'settings.websocketStatus': '下載 WebSocket',
      'settings.websocketConnecting': '正在連線下載即時狀態通道。',
      'settings.websocketConnected': '下載即時狀態通道已連線。',
      'settings.websocketReconnecting': '下載即時狀態通道正在重新連線。',
      'settings.websocketDisconnected': '下載即時狀態通道未連線，請檢查反向代理 WebSocket 轉發。',
      'settings.troubleshootingLoadFailed': '載入排障資訊失敗: @error',
      'settings.troubleshootingProbeFailed': '排障測試失敗: @error',
      'settings.troubleshootingSummary': '排障總覽',
      'settings.troubleshootingSummaryBody': '發現 @count 個需要關注的項目。',
      'settings.troubleshootingIssueList': '需要處理的問題',
      'settings.troubleshootingNoIssues': '目前沒有需要處理的問題。',
      'settings.troubleshootingOpenTarget': '開啟相關頁面',
      'settings.troubleshootingRetest': '重新測試',
      'settings.troubleshootingCopyFix': '複製修復片段',
      'settings.troubleshootingRunAction': '執行修復',
      'settings.troubleshootingActionConfirm': '將對符合條件的失敗任務執行批量修復操作，是否繼續？',
      'settings.troubleshootingActionDone': '修復操作已完成',
      'settings.troubleshootingActiveProbe': '手動主動測試',
      'settings.troubleshootingActiveProbeHint':
          '僅在點擊後存取外網；可測試 EH/EX、H@H 圖片節點和 GPU/超解析執行環境。',
      'settings.troubleshootingHathUrl': 'H@H 圖片 URL（可選）',
      'settings.runTroubleshootingProbe': '執行排障測試',
      'settings.troubleshootingProbe_network': 'EH/EX 網路',
      'settings.troubleshootingProbe_hath': 'H@H 圖片節點',
      'settings.troubleshootingProbe_superResolution': 'GPU/超解析環境',
      'settings.troubleshootingProbe_downloads': '下載失敗',
      'settings.troubleshootingFailedJobs': '失敗任務',
      'settings.troubleshootingGpuDevices': 'GPU 裝置',
      'settings.copyGpuComposeSnippet': '複製 GPU compose 片段',
      'settings.troubleshootingRecentProblems': '最近問題日誌',
      'settings.troubleshootingNoRecentProblems': '最近沒有 warning/error 日誌。',
      'settings.troubleshootingActions': '建議操作',
      'settings.troubleshootingSkipped': '已跳過',
      'settings.proxyHasCredentials': '已設定認證',
      'settings.logCount': '日誌數量',
      'settings.logTotalSize': '日誌大小',
      ...
      'settings.archiveParseSource': '封存解析來源',
      'settings.archiveParseOfficial': '官方 EH 封存',
      ...
      'settings.archiveParseChangeHint': '切換解析來源會清空已解析連結並重新排隊。',
      'speedLimit': '下載速度限制',
      ...
      'settings.restoreTasksLoadFailed': '載入工作自動復原設定失敗: @error',
      'settings.speedLimitLoadFailed': '載入下載速度限制失敗: @error',
      'settings.downloadServerRuntime': '伺服器執行參數',
      'settings.runtimeLoadFailed': '載入伺服器執行參數失敗: @error',
      ...
      'settings.archiveBotHint':
          '可選第三方封存解析服務，預設不會使用。設定 API key 後，封存工作可手動選擇 Bot 解析來源。',
      'settings.archiveBotProtocol': '協定',
      'settings.archiveBotApiAddress': 'API 位址',
      'settings.archiveBotApiKey': 'API key',
      'settings.archiveBotApiKeyConfigured': '已儲存 API key；留空儲存會保留目前 key。',
      'settings.archiveBotApiKeyNotConfigured': '未設定 API key。',
      'settings.archiveBotTestBalance': '測試餘額',
      'settings.archiveBotCheckIn': '簽到',
      'settings.archiveBotSaved': 'Archive Bot 設定已儲存',
      'settings.archiveBotBalanceResult': '目前餘額: @balance',
      'settings.archiveBotLoadFailed': '載入 Archive Bot 設定失敗: @error',
      'settings.archiveBotSaveFailed': '儲存 Archive Bot 設定失敗: @error',
      'settings.archiveBotActionFailed': 'Archive Bot 請求失敗: @error',
      ...
      'settings.performancePresetTitle': '效能預設',
      'settings.performancePresetHint': '一鍵調整閱讀預載和下載頁動畫閾值；套用後仍可在閱讀設定中單獨修改。',
      ...
      'settings.importDataSuccessDetail': '已匯入 @count 項資料：@detail',
      'settings.importNoChange': '匯入完成，但沒有寫入新的資料。請檢查預檢結果或檔案內容。',
      'settings.importDataFailed': '匯入資料失敗：@error',
      'settings.importStatusAnalyzing': '已讀取 @name（@size），正在預檢。',
      'settings.importStatusCancelled': '已取消匯入：@name',
      'settings.importStatusBackingUp': '正在下載匯入前備份。',
      'settings.importStatusImporting': '正在匯入 @name。',
      'settings.importStatusDone': '@source 已匯入 @count 項：@detail',
      'settings.importStatusNoChange': '@source 匯入完成，但沒有寫入新的資料。',
      'settings.importStatusFailed': '匯入失敗：@error',
      'settings.importPreviewTitle': '匯入預檢',
      'settings.importPreviewSource': '來源：@source',
      'settings.importPreviewFile': '檔案：@name（@size）',
      'settings.importSourceWeb': 'Web 匯出',
      'settings.importSourceApp': 'App / 雲端設定',
      'settings.importPreviewSummary':
          '可匯入 @count 項，可能覆蓋 @replace 項，略過 @skip 項。',
      'settings.importPreviewEmpty': '沒有發現可匯入項目。檔案已讀取，但內容不會寫入目前服務端。',
      'settings.importPreviewLocalReadHint': '檔案只在瀏覽器中讀取；點擊「備份並匯入」後才會寫入服務端。',
      'settings.importPreviewBackupHint': '確認後會先自動下載目前 Web 資料備份，再執行匯入。',
      'settings.importPreviewOverwriteHint':
          '匯入會合併資料；設定、歷史、搜尋歷史和快速搜尋可能依相同 key / gid / keyword / name 覆蓋。',
      'settings.importConfirmWithBackup': '備份並匯入',
      'settings.importSectionSummary': '匯入 @count · 覆蓋 @replace · 略過 @skip',
      'settings.importSectionConfig': '設定',
      'settings.importSectionBlockRules': '屏蔽規則',
      'settings.importSectionHistory': '瀏覽歷史',
      'settings.importSectionSearchHistory': '搜尋歷史',
      'settings.importSectionQuickSearch': '快速搜尋',
      'settings.importSectionReadProgress': '閱讀進度',
      ...
      'settings.cloudConfigLoadFailed': '載入雲端設定失敗：@error',
      'settings.cloudShareCodeLoadFailed': '查詢分享碼失敗：@error',
      'settings.uploadCloudConfig': '上傳至雲端',
      'settings.uploadCloudConfigTitle': '上傳目前資料到雲端？',
      'settings.uploadCloudConfigConfirm': '選擇要上傳到 JHenTai 雲端設定服務的本機資料類型。',
      'settings.uploadCloudConfigSuccess': '雲端設定已上傳',
      'settings.uploadCloudConfigFailed': '上傳雲端設定失敗：@error',
      ...
      'settings.loadWheelSettingsFailed': '載入滑鼠滾輪設定失敗：@error',
      'settings.saveWheelSettingsFailed': '儲存滑鼠滾輪設定失敗：@error',
      ...
      'history.deleteSuccess': '瀏覽記錄已刪除',
      'history.deleteFailed': '刪除瀏覽記錄失敗: @error',
      'history.clearSuccess': '瀏覽記錄已清空',
      'history.clearFailed': '清空瀏覽記錄失敗: @error',
      ...
      'quickSearch.orderSaveFailed': '儲存快速搜尋排序失敗: @error',
      ...
      'useBuiltInBlockedUsersLoadFailed': '載入內建使用者封鎖名單設定失敗: @error',
      'blockRule.ruleCount': '@count 條規則',
      'blockRule.ungrouped': '未分組',
      'blockRule.deleteGroup': '刪除分組',
      'blockRule.deleteGroupTitle': '刪除封鎖規則分組',
      'blockRule.deleteGroupConfirm': '確定刪除分組「@group」及其中 @count 條規則？',
      'blockRule.deleteRuleTitle': '刪除封鎖規則',
      'blockRule.deleteRuleConfirm': '確定刪除規則「@rule」？',
      'blockRule.loadFailed': '載入封鎖規則失敗: @error',
      'blockRule.saveFailed': '儲存封鎖規則失敗: @error',
      'blockRule.deleteFailed': '刪除封鎖規則失敗: @error',
      'blockRule.saveSuccess': '封鎖規則已儲存',
      'blockRule.deleteSuccess': '封鎖規則已刪除',
      'blockRule.target': '目標',
      ...
      'usertags.watch': '關注',
      'usertags.hidden': '隱藏',
      'usertags.watchInSet': '選擇標籤集關注',
      'usertags.hiddenInSet': '選擇標籤集隱藏',
      'usertags.manage': '管理標籤集',
      ...
      'downloads.priorityLow': '低',
      'downloads.priorityMedium': '中',
      'downloads.priorityHigh': '高',
      'downloads.setGroup': '分組',
      'downloads.priorityLabel': '優先級',
      'downloads.groupLabel': '分組',
      'downloads.defaultGroup': '預設',
      ...
      'downloads.clearGroupConfirm': '將「@group」中的 @count 個任務移回預設分組？',
      'downloads.groupCleared': '已將 @count 個任務移回預設分組',
      ...
      'downloads.failedIssueSummary':
          '發現 @total 個失敗任務（畫廊 @gallery，歸檔 @archive）。',
      'downloads.retryFailedGallery': '重試失敗畫廊',
      'downloads.retryFailedArchive': '重試失敗歸檔',
      'downloads.retryFailed': '重試失敗任務',
      'downloads.reUnlockFailedArchive': '重新解鎖失敗歸檔',
      'downloads.failedGalleryRetried': '已重試 @count 個失敗畫廊任務',
      'downloads.failedArchiveRetried': '已重試 @count 個失敗歸檔任務',
      'downloads.failedArchiveReUnlocked': '已重新解鎖 @count 個失敗歸檔任務',
      'downloads.issue_hath': '@count 個 H@H／代理失敗',
      'downloads.issue_hath_hint': '檢查 H@H URL、JH_HATH_PROXY 和反代網路路徑。',
      'downloads.issue_quota': '@count 個配額／509 限制',
      'downloads.issue_quota_hint': '等待配額恢復或在 EH 狀態頁重置圖片限制後再重試。',
      'downloads.issue_imagePage': '@count 個圖片頁解析／下載失敗',
      'downloads.issue_imagePage_hint': '通常可直接重試；若持續失敗，請執行 H@H 主動測試。',
      'downloads.issue_archiveUnlock': '@count 個歸檔解鎖失敗',
      'downloads.issue_archiveUnlock_hint': '重新解鎖歸檔，必要時檢查登入 Cookie 和網路代理。',
      'downloads.issue_archiveDownload': '@count 個歸檔下載／解壓失敗',
      'downloads.issue_archiveDownload_hint': '重試歸檔任務；若下載連結過期，先重新解鎖。',
      'downloads.issue_archiveBot': '@count 個 Archive Bot 解析失敗',
      'downloads.issue_archiveBot_hint':
          '檢查 Archive Bot / Archive-at-Home API 位址、API key 和餘額，或切回官方封存解析。',
      'downloads.issue_localFile': '@count 個本機檔案異常',
      'downloads.issue_localFile_hint': '檢查下載目錄掛載、權限和 NAS 磁碟狀態。',
      'downloads.issue_unknown': '@count 個未知失敗',
      'downloads.issue_unknown_hint': '開啟排障工作台複製診斷包，並檢視最近伺服器日誌。',

      'detail.startDownloadTitle': '開始下載',
      'detail.downloadGroup': '分組',
      'existingGroup': '現有分組',
      'groupName': '分組名稱',
      'detail.downloadPriority': '優先級',
      'detail.stats': '統計',
